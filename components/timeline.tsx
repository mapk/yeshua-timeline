  ...
  return (
    <div className="w-full bg-white dark:bg-neutral-950 font-sans md:px-10 pb-20" ref={containerRef}>
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg font-semibold mb-4 text-black dark:text-white max-w-4xl">Yeshua's Purpose</h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-xlg">
